//! The Mosaic — Speculum's lead view (P§3, P§9, §12).
//!
...
//! by construction (P§3). Speculum's own tiles count every core the mirror reflects;
//! the dated review with its horizon control is the second view ([`crate::horizon`]).
